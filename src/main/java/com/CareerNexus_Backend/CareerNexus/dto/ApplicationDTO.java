...
public class ApplicationDTO {
    ...
    private Long id;
    private UserDTO student; // DTO for the student who applied
    private JobPostDTO jobPost; // DTO for the job post
    ...
    public String getAppliedResumeUrl() { return appliedResumeUrl; }
    public void setAppliedResumeUrl(String appliedResumeUrl) { this.appliedResumeUrl = appliedResumeUrl; }
}